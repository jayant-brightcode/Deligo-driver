...
const OrderPickupScreen = () => {
  ...
  return (
    <GestureHandlerRootView style={style.container}>
      ...
      <Text
                style={{marginTop: '3%', fontFamily: 'urbanistregular',fontSize:13,color:Colors.red,alignSelf:'center'}}>*Make sure to manually verify all the items before picking up</Text>
...
<SwipeButton
      ...
      onSwipeSuccess={() =>
       {
         navigation.navigate("CustomerDirectionScreen")
       }
      }
